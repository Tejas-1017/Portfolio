...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-10 w-[300px] md:w-[450px] h-[300px] md:h-[450px] bg-cyan-500/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[350px] md:w-[500px] h-[350px] md:h-[500px] bg-purple-600/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 items-center gap-8 md:gap-12 relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-left">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 max-w-md mb-6 md:mb-10 font-mono text-xs">
            <div className="p-2.5 sm:p-3 rounded-lg glass-panel border border-white/10 flex flex-col">
