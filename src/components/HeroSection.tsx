  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-10 w-[300px] md:w-[450px] h-[300px] md:h-[450px] bg-cyan-500/10 rounded-full blur-[120px] pointer-events-none"
      />
      <motion.div
        animate={{
          scale: [1.2, 1, 1.2],
        ...
        className="absolute bottom-10 right-10 w-[350px] md:w-[500px] h-[350px] md:h-[500px] bg-purple-600/10 rounded-full blur-[140px] pointer-events-none"
      />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 items-center gap-8 md:gap-12 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 md:gap-3 px-3 py-1.5 md:px-4 md:py-2 rounded-full glass-panel border border-cyan-500/30 text-[11px] md:text-xs font-mono text-cyan-300 mb-4 md:mb-6 w-max shadow-[0_0_15px_rgba(0,243,255,0.15)]"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-7xl lg:text-8xl font-extrabold uppercase text-white tracking-tight leading-[0.95] mb-4 md:mb-6"
          >
            TEJAS <br />
          ...
          <motion.p
            ...
            className="text-slate-300 text-sm sm:text-lg max-w-xl font-light leading-relaxed mb-6 md:mb-8"
          >
          ...
          <motion.div
            ...
            className="grid grid-cols-3 gap-2 sm:gap-4 max-w-md mb-6 md:mb-10 font-mono text-xs"
          >
